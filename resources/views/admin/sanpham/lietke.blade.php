                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  ?>
                    <tr>
                      ...
                      <!--<td style="text-align: center;"><a href="{{URL::to('/them-thuoctinh/'.$sanpham->sanpham_id)}}">Thêm thuộc tính</a></td>-->
                      <td style="text-align: center;"><img src="uploads/{{$sanpham->sanpham_hinhanh}}" width="80" height="80"></td>
                      <td style="text-align: center;">{{number_format($sanpham->sanpham_gia).' vnđ'}}</td>
